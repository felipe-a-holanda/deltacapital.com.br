...
def owner_perms():
    ...
    owner.permissions.remove(*Permission.objects.filter(content_type__app_label='site'))
    owner.permissions.remove(*Permission.objects.filter(content_type__app_label='account'))
    owner.permissions.remove(*Permission.objects.filter(content_type__app_label='socialaccount'))
